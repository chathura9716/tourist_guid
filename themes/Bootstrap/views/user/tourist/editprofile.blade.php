            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="{{asset('thumbnails/'.$data->thumbnail)}}" alt="..." class="w-100 border-radius-lg shadow-sm">
        ...
        <div class="card">
            <div class="card-header pb-0 px-3">
                ...
                <div class="card-body pt-4 p-3">
                        ...
                        <form action="{{route('touristprofileupdate',$data->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                <div>
                                    @if($errors->any())
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="thumbnail" class="form-control-label">{{ __('Profile Photo') }}</label>
                                                <div class="@error('user.name')border border-danger rounded-3 @enderror">
                                                    <input class="form-control" value=" {{$data->thumbnail}}" type="file" placeholder="thumbnail" id="thumbnail" name="thumbnail">
                                                        @error('thumbnail')
                                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                                        @enderror
                                                </div>
