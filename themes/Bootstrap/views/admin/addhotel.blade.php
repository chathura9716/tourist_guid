...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Add Hotel Agency') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.create') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                               <select id="role" name="role" class="form-select" aria-label="Default select example" required autocomplete="role">
                               
                                <option selected  >Hotel Agency</option>
                                <option value="{{ old('targency') }}">Travel Agency</option>
